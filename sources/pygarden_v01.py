...
dico_AMIS = {"ail":{'carotte', 'concombre', 'oignon', 'fraise', 'tomate', 'epinard', 'patate', 'navet'},"artichaut":{'asperge', 'laitue'},
"aubergine":{'haricot', 'tomate', 'pois', 'piment', 'thym', 'persil', 'estragon'},
"asperge":{'persil', 'poireau', 'tomate'},"aubergine":{'haricot', 'tomate', 'pois', 'piment', 'thym', 'persil', 'estragon'},
...
"choux":{'betterave', 'haricot', 'laitue', 'petit pois', 'salade', 'tomate'},
"courge":{'ciboulette', 'echalotte', 'haricot', 'oignon', 'petit pois'},
"courgette":{'ciboulette', 'echalotte', 'haricot', 'oignon', 'petit pois'},
"concombre":{'aneth', 'choux', 'haricot', 'laitue', 'oignon'},"epinard":{'haricot', 'petit pois', 'fraise', 'choux', 'radis', 'salade', 'tomate'},
"feve":{'tomate', 'fraise', 'courge'},
"fraise":{'ail', 'laitue', 'oignon', 'poireau', 'echalote', 'persil', 'sauge'},
"haricot":{'carotte', 'choux', 'fraise', 'laitue', 'aubergine', 'celeri', 'courgette', 'poireau', 'radis', 'patate'},
"laitue":{'chou-fleur', 'aneth', 'carotte', 'radis', 'fraise', 'concombre', 'courge', 'poireau'},
"mache":{'ail', 'basilic', 'haricot', 'pois', 'radis'},
"melon":{'mais','citrouille','courge','radis','epinard', 'tournesol', 'potiron'},"navet":{'ail', 'celeri', 'ciboulette', 'epinard', 'petit pois'},
"oignon":{'aneth', 'ail', 'carotte', 'concombre', 'salade', 'tomate'},"Petit pois":{'carotte', 'epinard', 'radis', 'choux', 'mache', 'patate'},
"piment":{'basilic', 'carotte', 'oignon'},"poireau":{'carotte', 'fraise', 'epinard', 'tomate'},
"poivron":{'aubergine','tomate','carotte','oignon','pois','trefle','fraise'},
"patate":{'ail', 'haricot', 'pois'},"radis":{'carotte', 'fraise', 'haricot', 'salade', 'tomate', 'cresson'},
"salade":{'aneth', 'betterave', 'concombre', 'choux', 'epinard', 'haricot', 'petit pois', 'radis', 'tomate'},
"thym":{'choux', 'brocolis'},
"tomate":{'carotte', 'choux', 'epinard', 'oignon', 'persil', 'poireau', 'salade', 'basilic'}}


dico_ENNEMIS = {"ail":{'choux', 'haricot'},"asperge":{'ail', 'choux', 'echalote', 'oignon', 'poireeee'},
"aubergine":{'oignon', 'patate'},"betterave":{'epinard'},"carotte":{'betterave', 'menthe'},
"choux":{'autres varietes de chouxxxxx', 'ail'},"courgette et courge":{'concombre'},"concombre":{'radis'},"epinard":{'betterave rouge'},
"feve":{'ail', 'ciboulette'},"fraise":{'choux'},"haricot":{'ail', 'oignon', 'pois', 'poireau'},
"mache":{'choux', 'epinard', 'salade'},"melon":{'concombre'},"navet":{'radis'},"oignon":{'haricot', 'petit pois', 'poireau', 'choux', 'feve'},
"petit pois":{'ail', 'echalotte', 'oignon', 'tomate'},"Piment":{'fenouil'},
"poireau":{'haricot', 'pois'},"patate":{'aubergine', 'courgette', 'radis', 'tomate'},"radis":{'cerfeuil' , 'concombre'},
"salade":{'persil', 'tournesol'},"tomate":{'betterave', 'choux rouge', 'fenouil', 'pois'}}



set_Legumes = {'carotte','concombre', 'tomate', 'epinard', 'patate', 'navet','asperge', 'laitue','haricot','poireau', 'radis','choux',
'courgette','epinard','betterave','pois','potiron','aubergine','endive','artichaut','navet'}

set_Fruits = {'fraise','melon','framboise','groseille','cassis','pomme','poire','abricot','raisin','prune','peche','cerise','noisette','pasteque','figue','citron','orange'}

set_Aromates = {'ail','piment', 'thym', 'persil', 'estragon','basilic','aneth','menthe','ciboulette', 'echalotte','oignon','celeri','moutarde','cerfeuil','melisse','tanaisie'}


set_Cereales = {'ble','mais','sarasin','orge','millet','seigle','epautre','lentilles','quinoa'}

set_Fleurs = {'oeillet Inde','tabac','capucine','ortie','souci','petunia','bourrache','myosotis','chicoree','chardon','coquelicot','echinacee','aster',
			  'lavande','consoude','prele','hysope','micromerie','phlomis','dracocephale','asclepiade','ammi','centauree','buplevre','ciste','zinnia',
			  'sceau-de-salomon','eupatoire','miscanthus','verveine','luzerne','colza','lin','trefle','tournesol','rose','pissenlit','bleuet','pelargonium','armoise'}
...
class Big_carre():
	...
	def __init__(self,Case_5=set(),Case_8=set(),Case_9=set(),Case_6=set(),Case_3=set(),Case_2=set(),Case_1=set(),Case_4=set(),Case_7=set(),Case_0=set(),TargetCase = None, presents=set(),GREENset=set(),REDset=set(),DISCORDset=set(),zeroHAINE=set()):
			...
			if present in self.REDset:
				...
				try:
					for suspect in dico_ENNEMIS[present]:
						if suspect in self.presents:	print("Attention  à ",present," qui semble etre en conflit avec :",suspect)

				except KeyError:
					
					print("KeyError entre  ",present," et le dico_ENNEMIS : MERCI de mettre à jour ou signaler ce bug (penser a relever le traceback si possible) ")
			else:
				pass
	...
	def show_ennemis_respectifs(self):
		...
		for mangeable in (self.presents):
			...
			try:
				...
				print(Back.BLACK + Fore.RED + Style.NORMAL +"\n ",mangeable,"est ennemi avec  :",dico_ENNEMIS[mangeable])
	...
	def show_DISCORDANTS(self):
		...
		if len(mon_bigcarre.DISCORDset) > 0:
			...
			print (Back.BLACK + Fore.CYAN + Style.BRIGHT +" \n Voici les especes ambigues discordantes :  ",self.DISCORDset)
	...
	def show_REDset(self):
		...
		if len(mon_bigcarre.REDset) > 0:
			...
			print (Back.RED + Fore.BLACK + Style.NORMAL +" \n Voici les rivales a eviter dans ce big carre : REDset =  "+Back.RED + Fore.BLACK + Style.BRIGHT,self.REDset)
		...
		for v in dico_AMIS.values():
			...
			for element in v:
				...
				if element not in dico_AMIS.keys():
					...
					print("\n plante renseignee de facon unidirectionnelle : il manque dans dico_AMIS la clef  ",element)
			...
			for pretendue_amie in dico_AMIS[plante_test]:
				...
				try:
					...
					if pretendue_amie in dico_ENNEMIS[plante_test]:
						...
						print(Back.BLACK + Fore.RED + Style.BRIGHT +" \n AgentDouble decouvert : verifier pretendue_amie  :  ",pretendue_amie," chez la pauvre plante_test ",plante_test)
						print (Back.BLACK + Fore.WHITE + Style.NORMAL +"\n ")
					
				except KeyError:

					print(" \n KeyError decouvert avec pretendue_amie  :  ",pretendue_amie," et plante_test ",plante_test)
...
def show_bigcarre():
	...
	print("\n")
	print("Case_7   :  ",mon_bigcarre.Case_7,"		Case_8   :  ",mon_bigcarre.Case_8,"		Case_9   :  ",mon_bigcarre.Case_9)
	print("\n")
	print("Case_4   :  ",mon_bigcarre.Case_4,"		Case_5   :  ",mon_bigcarre.Case_5,"		Case_6   :  ",mon_bigcarre.Case_6)
	print("\n")
	print("Case_1   :  ",mon_bigcarre.Case_1,"		Case_2   :  ",mon_bigcarre.Case_2,"		Case_3   :  ",mon_bigcarre.Case_3)
	print("\n")
...
def show_brouette():
	...
	print("\n")
	print(Back.BLACK + Fore.WHITE + Style.NORMAL +"A planter / repiquer , en attente sur votre brouette 			: Case_0   =  ",mon_bigcarre.Case_0)
...
def choisir_legume():
	...
	print(Back.BLACK + Fore.GREEN + Style.BRIGHT +"\n Vous avez choisi :  ", choix_legume,"  : ",catalogue_legume[choix_legume])
...
def choisir_fruit():
	...
	print(Back.BLACK + Fore.RED + Style.BRIGHT +"\n Vous avez choisi :  ", choix_fruit,"  : ",catalogue_fruit[choix_fruit])
...
def choisir_aromate():
	...
	print(Back.CYAN + Fore.BLUE + Style.BRIGHT +"\n Vous avez choisi :  ", choix_aromate,"  : ",catalogue_aromate[choix_aromate])
...
def choisir_cereale():
	...
	print(Back.BLACK + Fore.YELLOW + Style.BRIGHT +"\n Vous avez choisi :  ", choix_cereale,"  : ",catalogue_cereale[choix_cereale])
...
def choisir_fleur():
	...
	print(Back.BLACK + Fore.MAGENTA + Style.BRIGHT +"\n Vous avez choisi :  ", choix_fleur,"  : ",catalogue_fleur[choix_fleur])
...
def choisir_type():	
	...
	print(Back.WHITE + Fore.BLACK + Style.NORMAL +"\n\nQue voulez vous planter ?		 "+Back.BLACK + Fore.GREEN + Style.NORMAL +" 0 => Legume   "+Back.BLACK + Fore.RED + Style.NORMAL +"  1 => Fruit  "+Back.BLUE + Fore.CYAN + Style.NORMAL +"  2=> Aromates   "+Back.BLACK + Fore.YELLOW + Style.NORMAL +"   3 => Cereale  "+Back.BLACK + Fore.MAGENTA + Style.NORMAL +"  4=> Fleur " + Back.BLACK + Fore.BLACK + Style.NORMAL + "  \n\n\n"+ Back.BLACK + Fore.WHITE + Style.BRIGHT)
...
def rappeller_complementaire():
	...
	try:
		...
		print(Back.BLACK + Fore.GREEN + Style.NORMAL +"\n Voici les amis de  ",', '.join(mon_bigcarre.Case_0),"  :  ",dico_AMIS[', '.join(mon_bigcarre.Case_0)])
	except KeyError:
	...
	try:
		print(Back.BLACK + Fore.RED + Style.NORMAL +"\n Voici les ennemis de  ",', '.join(mon_bigcarre.Case_0),"  :  ",dico_ENNEMIS[', '.join(mon_bigcarre.Case_0)])
	except KeyError:
		...
		if len(mon_bigcarre.Case_0) == 1:
			...
			for key in mon_bigcarre.Case_0:
				try :
					...
					print("KeyError avec  ",key," verifier son absence dans dico_ENNEMIS ou dico_AMIS")
...
def choisirGeometry():
	...
	if choixGeometry == 0:
		...
		mon_bigcarre.Case_7 = mon_bigcarre.Case_9 = mon_bigcarre.Case_5 = mon_bigcarre.Case_1 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)


	if choixGeometry == 1:

		mon_bigcarre.Case_7 = mon_bigcarre.Case_8 = mon_bigcarre.Case_9 = mon_bigcarre.Case_4 = mon_bigcarre.Case_6 = mon_bigcarre.Case_1 = mon_bigcarre.Case_2 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)
		 


	elif choixGeometry == 2:

		mon_bigcarre.Case_7 = mon_bigcarre.Case_9 = mon_bigcarre.Case_4 = mon_bigcarre.Case_6 = mon_bigcarre.Case_1 = mon_bigcarre.Case_2 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)		
		


	elif choixGeometry == 3:

		mon_bigcarre.Case_7 = mon_bigcarre.Case_8 = mon_bigcarre.Case_9 = mon_bigcarre.Case_1 = mon_bigcarre.Case_2 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)
		


	elif choixGeometry == 4:

		mon_bigcarre.Case_8 = mon_bigcarre.Case_4 = mon_bigcarre.Case_5 = mon_bigcarre.Case_6 = mon_bigcarre.Case_2 = copy.deepcopy(mon_bigcarre.Case_0)		
		...
		mon_bigcarre.Case_8 = mon_bigcarre.Case_4 = mon_bigcarre.Case_6 = mon_bigcarre.Case_2 = copy.deepcopy(mon_bigcarre.Case_0)	
		


	elif choixGeometry == 6:

		mon_bigcarre.Case_8 = mon_bigcarre.Case_1 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)			


	elif choixGeometry == 7:

		mon_bigcarre.Case_8 = mon_bigcarre.Case_2 = copy.deepcopy(mon_bigcarre.Case_0)			
		...
		mon_bigcarre.Case_7 = mon_bigcarre.Case_9 = mon_bigcarre.Case_1 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)
		

	if choixGeometry == 10:

		mon_bigcarre.Case_4 = mon_bigcarre.Case_5 = mon_bigcarre.Case_6 = copy.deepcopy(mon_bigcarre.Case_0)
		

	if choixGeometry == 11:

		mon_bigcarre.Case_1 = mon_bigcarre.Case_5 = mon_bigcarre.Case_9 = copy.deepcopy(mon_bigcarre.Case_0)

		
	if choixGeometry == 12:

		mon_bigcarre.Case_7 = mon_bigcarre.Case_5 = mon_bigcarre.Case_3 = copy.deepcopy(mon_bigcarre.Case_0)
